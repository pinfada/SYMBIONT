...
|---|---|---|
| **1. Manifest & build** | Double manifest (Chrome/Firefox), `browser_specific_settings.gecko`, `background.scripts`, retrait `offscreen` côté Firefox, auto-hébergement des polices, correction des permissions (m1) | 1–2 j |
