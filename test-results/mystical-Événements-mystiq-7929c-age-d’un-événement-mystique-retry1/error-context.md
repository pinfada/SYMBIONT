...
- Name: Événements mystiques et rituels SYMBIONT >> Affichage d’un événement mystique
- Location: /mnt/c/Users/m_oli/Projets/SYMBIONT/tests/e2e/mystical.spec.ts:15:7
...
Call log:
  - waiting for locator('text=/Mystique|Mystical/i')

    at /mnt/c/Users/m_oli/Projets/SYMBIONT/tests/e2e/mystical.spec.ts:17:16
```
